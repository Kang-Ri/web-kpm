    ...
    useEffect(() => {
        if (product) {
            ...
            setFormData({
                ...
                kategoriHarga: (product.kategoriHarga || 'Gratis') as 'Gratis' | 'Seikhlasnya' | 'Bernominal',
                hargaModal: product.hargaModal || 0,
                hargaJual: product.hargaJual || 0,
                jenisProduk: (product.jenisProduk || 'Produk') as 'Materi' | 'Produk' | 'Daftar Ulang' | 'Lainnya',
                authProduk: (product.authProduk || 'Umum') as 'Umum' | 'Khusus',
                refCode: product.refCode || '',
                statusProduk: (product.statusProduk || 'Draft') as 'Draft' | 'Publish' | 'Non-Aktif',
            ...
            setFormData({
                ...
                namaProduk: '',
                descProduk: '',
                kategoriHarga: 'Gratis' as 'Gratis' | 'Seikhlasnya' | 'Bernominal',
                hargaModal: 0,
                hargaJual: 0,
                jenisProduk: 'Produk' as 'Materi' | 'Produk' | 'Daftar Ulang' | 'Lainnya',
                authProduk: 'Umum' as 'Umum' | 'Khusus',
                refCode: '',
                statusProduk: 'Draft' as 'Draft' | 'Publish' | 'Non-Aktif',
                tanggalPublish: null,
                // Inventory fields with defaults
                stokProduk: 0,
                trackInventory: true,
